...
class ProductsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'sub_categories_key' => ['type' => 'index', 'columns' => ['sub_category_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'sub_categories_key' => ['type' => 'foreign', 'columns' => ['sub_category_id'], 'references' => ['sub_categories', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
